...
import { type TransactionReceipt, type Log, decodeEventLog, type Address } from 'viem';
import { type WithdrawalMessage } from '../types/WithdrawalMessage.js';

export function getWithdrawalMessage(withdrawalReceipt: TransactionReceipt, l2L1MessagePasserAddress: Address): WithdrawalMessage {
